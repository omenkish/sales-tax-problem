...
- transform_data_spec.rb - tests for file input being parsed correctly
- tax_calculator_spec.rb - tests for calculating sales tax and totals
- printer_spec.rb - tests for printing the output
- tax_runner.rb - tests that the 3 input files output correctly